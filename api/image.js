...
export default async function handler(req, res) {
  try {
    ...
    if (type === 'player') {
                            ...
                            children: [
                              ...
                              d.captain
                                ? {
                                    type: 'span',
                                    props: {
                                      style: { fontSize: 10, fontWeight: 'bold', backgroundColor: '#ffcc00', color: '#000', padding: '2px 6px', borderRadius: 4 },
                                      children: 'C',
                                    },
                                  }
                                : null,
              ...
              props: {
                ...
                children: statCards.map((stat) => ({
                  ...
                  props: {
                    ...
                    children: [
                      { type: 'span', props: { style: { fontSize: 22, fontWeight: 'bold', color: '#ffcc00', lineHeight: 1.05 }, children: stat.value } },
      ...
      const homeRows = Array.from({ length: 11 }, (_, i) => shortName(homeXI[i]));
      const awayRows = Array.from({ length: 11 }, (_, i) => shortName(awayXI[i]));
      const matchTime = kickoffTR(d.kickoff);
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    props: {
                      ...
                      children: {
                        type: 'span',
                        props: { style: { fontSize: 10, color: '#888', textTransform: 'uppercase', letterSpacing: 1 }, children: 'Starting XI' },
                      },
                    },
                  },
                ],
            ...
            },
            {
              ...
              props: {
                ...
                children: {
                  type: 'span',
                  props: {
                    style: { fontSize: 12, color: '#9aa0aa' },
                    children: `${d.league || ''}${d.round ? ` • ${d.round}` : ''}`,
                  },
                },
              },
            },
              ...
              props: {
                ...
                children: {
                  ...
                  props: {
                    ...
                    children: `${d.venue ? `📍 ${d.venue}` : ''}${d.referee ? `   •   Ref: ${d.referee}` : ''}${matchTime ? `   •   ${matchTime}` : ''}`,
                  },
                },
              },
            },
                ...
                children: [
                  {
                    ...
                    props: {
                      ...
                      children: [
                        ...
                        { type: 'span', props: { style: { fontSize: 16, fontWeight: 'bold' }, children: d.homeTeam || 'Home' } },
                      ].filter(Boolean),
                    },
                  },
                  {
                    ...
                    props: {
                      ...
                      children: {
                        type: 'span',
                        props: { style: { fontSize: 12, color: '#8aa1c0', textTransform: 'uppercase' }, children: d.statusShort || 'NS' },
                      },
                    },
                  },
                  {
                    ...
                    props: {
                      ...
                      children: [
                        { type: 'span', props: { style: { fontSize: 16, fontWeight: 'bold' }, children: d.awayTeam || 'Away' } },
                      ...
                      children: [
                        {
                          ...
                          props: {
                            ...
                            children: [
                              { type: 'span', props: { style: { fontSize: 11, color: '#00ff88', fontWeight: 'bold' }, children: d.homeTeam || 'Home' } },
                              { type: 'span', props: { style: { fontSize: 10, color: '#8aa1c0' }, children: d.homeFormation || '-' } },
                            ],
                          },
                        },
                        ...homeRows.map((name, i) => ({
                          ...
                          props: {
                            style: {
                              ...
                              alignItems: 'center',
                              height: 22,
                              borderBottom: i === 10 ? 'none' : '1px solid rgba(255,255,255,0.05)',
                            },
                            children: [
                      ...
                      children: [
                        {
                          ...
                          props: {
                            style: { display: 'flex', justifyContent: 'space-between', marginBottom: 8 },
                            children: [
                              { type: 'span', props: { style: { fontSize: 11, color: '#00d4ff', fontWeight: 'bold' }, children: d.awayTeam || 'Away' } },
                              { type: 'span', props: { style: { fontSize: 10, color: '#8aa1c0' }, children: d.awayFormation || '-' } },
                            ],
                          },
                        },
                        ...awayRows.map((name, i) => ({
